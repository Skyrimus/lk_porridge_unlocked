...
static struct LCM_setting_table lcm_init_setting[] = 
{
 ...
 //#power setting for VCI1/2/3, DC2/3
   //[SM31][Raymond]modify OTP LCM initial code -begin
...
{0xD0,6,{ 0x01,0x4B,0x41,0x00,0x31,0x97 }},
 //[SM31][Raymond]fix HW test case fail in -20 degree -end
   //[SM31][Raymond]modify OTP LCM initial code -end
...
LCM_DRIVER r6135otp_hd720_dsi_vdo_lcm_drv = 
{
    .name			= "r6135otp_hd720_dsi_vdo",
